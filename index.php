	...
	<nav class="navbar navbar-inverse" style="margin-top:5px;">
		<div class="container-fluid">
			<div class="banner">
				...
				<div style="color:red;margin-left:250px;margin-bottom:50px;margin-top:20px;font-size:30px;font-family:Bodoni MT Black;">
					Inventory System
				</div>
			</div>
		</div>
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" id="form-login">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="user_un">Username:</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="user_un" placeholder="Enter Username">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="user_pwd">Password:</label>
							<div class="col-sm-10"> 
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" role="form" id="form-login-admin">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="admin_un">Username:</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="admin_un" placeholder="Enter Username">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2" for="admin_pwd">Password:</label>
						<div class="col-sm-10"> 
